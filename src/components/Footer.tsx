import { ChevronRight, Rocket, MapPin, Linkedin, Twitter, Instagram } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-16 border-b border-slate-800">
          <div className="lg:col-span-4">
            <div className="flex items-center gap-2 text-white mb-6">
              ...
              <span className="text-2xl font-black tracking-tighter">Skillqon</span>
            </div>
      ...
      {social.icon}
          ...
          <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-4 text-sm">
                ...
                <li><a href="#" className="hover:text-blue-500 transition-colors">Cloud Architecture</a></li>
                <li><a href="#" className="hover:text-blue-500 transition-colors">AI Integrations</a></li>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm">
                ...
                <li><a href="#" className="hover:text-blue-500 transition-colors">Placement Cell</a></li>
            ...
            <div className="col-span-2 md:col-span-1">
              <h4 className="text-white font-bold mb-6 uppercase tracking-widest text-xs">Our Office</h4>
              <div className="flex gap-3">
                ...
                <address className="not-italic text-sm text-slate-400 leading-relaxed">
                  23-74/5, DJS Building,<br />
                  First Floor, Muttaicadu,<br />
                  Kumarapuram Post,<br />
                  Kanyakumari District – 629164,<br />
                  Tamil Nadu, India.
                </address>
              </div>
            </div>
        ...
        <div className="pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-xs text-slate-500">
            © {currentYear} Waretech Solutions Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
